        ...
        <div class="col-sm-12" style="padding:0 25px 0 30px;">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="post" action="index.php?mod=hr/sm_insert_position_fadd&id=<?= $_GET['id']?>" style="margin-top:15px;">
                        <div class="row">
                            <div class="col-sm-12">
...
<script>
function back_page(){
    window.location = "index.php?mod=hr/manage_add_position&id=<?= $_GET['id']?>";
}
</script>
