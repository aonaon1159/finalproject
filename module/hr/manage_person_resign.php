...
<div id="page-wrapper-hr">
    ...
    $query_rows = mysqli_query($conn, "SELECT * FROM hr_person WHERE deleted !=0 ");
        ...
        <div class="col-sm-12" style="padding:0 25px 0 30px;">
            <div class="panel panel-default">
                ...
                <div class="ibox-tools">
                    ...
                    </button><?php if ($_SESSION["level"] == 2) { ?>
                    <button type="button" class="btn btn-primary btn-sm" onclick="add_person();">
                        <i class="fa fa-sm fa-user-plus"></i> | เพิ่มข้อมูลบุคลากร
                    </button><?php } ?>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="table-responsive">
                        ...
                        <?php
                        $sql_select = "SELECT * FROM hr_person WHERE deleted !=1 ORDER BY person_createDate DESC LIMIT $start_rows,$rows_per_page ";
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                ...
                                                if ($status == 1) {
                                                    ...
                                                    onclick="window.location.href='index.php?mod=hr/form_edit_employment&edit_id=<?= $person[0] ?>';"<?php } ?>>
