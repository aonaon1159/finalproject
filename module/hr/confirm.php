                        ...
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table id='hr_table'
                                    ...
                                    <?php
                                    $sql_select = "SELECT hr_person.person_id, person_prename, person_firstname_thai, person_lastname_thai, person_phone FROM `hr_person` INNER JOIN hr_person_leave ON hr_person.person_id = hr_person_leave.person_id WHERE hr_person_leave.confirm = 0 AND hr_person_leave.deleted = 0 ORDER BY file_createDate ASC LIMIT $start_rows,$rows_per_page ";
                                    ...
                                    while (list($person_id ,$person_prename ,$person_firstname_thai ,$person_lastname_thai ,$person_phone) = mysqli_fetch_row($query_person)) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                ...
                                                <a href="index.php?mod=hr/manage_leave_person_request&id=<?=$person_id ?>"
