            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="ibox-tools">
                        ...
                        <div class="col-sm-3" style="padding:5px 0px 10px 0; text-align:right;">
                            <?php if ($_SESSION["level"] ==  2) { ?>
                                <button type="button" class="btn btn-primary btn-sm" onclick="add_leave();">
                                    <i class="fa fa-sm fa-wheelchair"></i> | เพิ่มข้อมูลลางาน
                                </button>
                            <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                ...
                                $sql_select = "SELECT leave_id ,person_leave_begin ,person_leave_end ,person_leave_time_begin1 ,person_leave_time_begin2 ,person_leave_time_end1 ,person_leave_time_end2 ,person_leave_status ,person_note 
                                FROM hr_person_leave 
                                WHERE person_id='$id' AND deleted = 0 AND confirm = 1 AND person_leave_status = $status AND (month(person_leave_begin) = '$m_sql' OR month(person_leave_begin) = '$m_la_sql')
                                ...
                                <tbody>
                                    <?php
                                    $i = 1;
                                    while (list($leave_id ,$person_leave_begin ,$person_leave_end ,$person_leave_time_begin1 ,$person_leave_time_begin2 ,$person_leave_time_end1 ,$person_leave_time_end2 ,$person_leave_status ,$person_note) = mysqli_fetch_row($query_person)) {
