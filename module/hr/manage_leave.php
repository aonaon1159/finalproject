                        ...
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table id='hr_table'
                                    ...
                                    <?php
                                    $sql_select = "SELECT person_id ,person_prename ,person_firstname_thai ,person_lastname_thai ,person_phone FROM hr_person WHERE deleted=0 ORDER BY person_createDate DESC LIMIT $start_rows,$rows_per_page ";
                                    ...
                                    while (list($person_id ,$person_prename ,$person_firstname_thai ,$person_lastname_thai ,$person_phone) = mysqli_fetch_row($query_person)) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                ...
                                                <a href="index.php?mod=hr/manage_leave_person&id=<?=$person_id ?>"
                                                   class="btn btn-xs btn-warning"><span class="fa fa-pencil-square-o"></span>  | ลาหยุด</a>
