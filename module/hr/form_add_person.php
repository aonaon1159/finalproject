                            ...
                            <div class="col-sm-12">
                                ...
                                <form id="form_add_person" class="form-horizontal" role="form" method="post"
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img id="preview" class="img-responsive"
                                                                     style="max-width:300px; max-height: 250px;  padding:5px; margin:0 auto;">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                                    ...
                                    <div class="col-sm-12 ">
                                        ...
                                        <div id="div_soldier">
                                            <div class="form-group col-sm-6">
                                                <label class="col-sm-4 control-label ">สถานภาพทางทหาร
                                                    : </label>
                                                <div class="col-sm-8">
                                                    <select id="soldier" name="soldier" class="form-control"
                                                            onchange="check_soldier();" ;>
                                                        <option value="0"> กรุณาเลือกสถานภาพทางทหาร</option>
                                                        <option value="1">อยู่ในระหว่างรับราชการทหาร</option>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="col-sm-8">
                                                <table>
                                                    <tr>
                                                        <td style="padding:7px 30px 0px 30px;">
                                                             <input type="radio" id="blood"
                                                                           name="blood"
                                                                           value="1"> O
                                                        </td>
                                                        <td style="padding:7px 30px 0px 30px;">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="col-sm-8">
                                                <select id="marital_status" name="marital_status"
                                                    ...
                                                    <option value="0">กรุณาเลือกสถานภาพสมรส</option>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" name="father_age" id="father_age" class="form-control" required>
                                        ...
                                        <div class="form-group col-sm-8">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="father_career"
                                                       name="father_career" placeholder="อาชีพบิดา"
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <label class="col-sm-4 control-label ">อายุ (ปี) : </label>
                                            <div class="col-sm-5">
                                                <input type="text" name="mother_age" id="mother_age" class="form-control" required>
                                        ...
                                        <div class="form-group col-sm-8">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="mother_career"
                                                       name="mother_career" placeholder="อาชีพมารดา"
...
//        console.log("fname thai : "+fname_thai);
    ...
    function check_email() {
        ...
        if (!email) {
            $("#alert_email").show().html("*กรุณากรอกอีเมล");
            alert_email = true;
            $("#email").focus();
        } else if (length > 50) {
    ...
    function check_father_career() {
        ...
        if (!length) {
            $("#alert_father_career").show().html("*กรุณากรอกอาชีพบิดา");
    ...
    function check_mother_career() {
        ...
        if (!length) {
            $("#alert_mother_career").show().html("*กรุณากรอกอาชีพบิดา");
    ...
    function check_sex() {
        ...
        if (sex == 0) {
            ...
            document.getElementById("prename").value = 0;
            $("#alert_prename").show().html("*กรุณาเลือกคำนำหน้าชื่อ");
            $("#alert_sex").show().html("*กรุณาเลือกเพศ");
            $("#div_soldier").hide();
            $("#sex").focus();
            ...
            document.getElementById("prename").value = 1;
            $("#div_soldier").show();
            $("#alert_sex").hide();
            $("#alert_prename").hide();
            alert_prename = false;
            ...
            document.getElementById("prename").value = 2;
            $("#div_soldier").hide();
            $("#alert_sex").hide();
            $("#alert_prename").hide();
            alert_prename = false;
