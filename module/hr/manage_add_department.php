                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <i class='btn btn-xs btn-danger fa fa-minus-square' onclick="del(<?=$department_id?>,<?=$_GET['id']?>)" style="cursor: pointer;"></i>
...
function del(id,edit_id){
    ...
    if (r == true) {
        window.location='index.php?mod=hr/sm_del_department_fadd&id='+id+'&edit_id='+edit_id;
    }
}
</script>
