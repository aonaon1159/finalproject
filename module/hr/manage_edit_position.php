                ...
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <div class="ibox-tools">
                            <a href="index.php?mod=hr/form_edit_position&id=<?= $_GET['id']?>"><i class="fa fa-sm fa-group"></i> | เพิ่มตำแหน่งงาน</a>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <i class='fas fa-trash-alt ' onclick="del(<?=$position_id?>,<?=$_GET['id']?>)" style="cursor: pointer;"></i>
...
function del(id,edit_id){
    ...
    if (r == true) {
        window.location='index.php?mod=hr/sm_del_position_fedit&id='+id+'&edit_id='+edit_id;
    }
}
</script>
