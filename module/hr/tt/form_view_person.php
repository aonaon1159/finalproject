                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <!--                                    action="index.php?mod=hr/sm_insert_person"-->
                                <form id="form_edit_person" class="form-horizontal" role="form" method="post"
                                    ...
                                    if ($employment[7] == 1) {
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group col-sm-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <?php
                                                    $sql_select_company = "SELECT company_name FROM hr_person_company WHERE company_id='$employment[2]' ";
                                                    $query_select_company = mysqli_query($conn, $sql_select_company);
                                                    list($company_name) = mysqli_fetch_row($query_select_company);
                                                    ?>
                                                    <input type="text" class="form-control"
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <?php
                                                    $sql_select_branch = "SELECT branch_name FROM hr_person_branch WHERE branch_id='$employment[3]' ";
                                                    $query_select_branch = mysqli_query($conn, $sql_select_branch);
                                                    list($branch_name) = mysqli_fetch_row($query_select_branch);
                                                    ?>
                                                    <input type="text" class="form-control"
                                                           ...
                                                           maxlength="50"
                                                           value="<?php if ($branch_name != "") echo $branch_name; else echo "*ยังไม่ได้เลือกสาขา"; ?>"
                                                           disabled>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="pager">
                                            <li><a href="index.php?mod=fn/form_view_detail&salary_id=<?=$_GET['id']?>&file_id=<?=$_GET['id']?>" class="btn btn-default">
                                                ย้อนกลับ
                                            </a></li>
                                        </div>
                                    </div>
