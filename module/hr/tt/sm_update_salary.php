...
if (isset($_POST["hidden_salary_id"]) && isset($_POST["hidden_file_id"])) {

    $sql_update_salary = "
            UPDATE fn_salary SET 
            salary_prefix_eng='{$_POST["salary_prefix_eng"]}',
            salary_name_eng='{$_POST["salary_name_eng"]}',
            salary_surname_eng='{$_POST["salary_surname_eng"]}',
            salary_fullname_thai='{$_POST["salary_fullname_thai"]}',
            salary_payment='{$_POST["salary_payment"]}',
            salary_position='{$_POST["salary_position"]}',
            salary_department='{$_POST["salary_department"]}',
            salary_section='{$_POST["salary_section"]}',
            salary_status='{$_POST["salary_status"]}',
            salary_income_rate='{$_POST["salary_income_rate"]}',
            salary_work_day='{$_POST["salary_work_day"]}',
            salary_income='{$_POST["salary_income"]}',
            salary_income_position='{$_POST["salary_income_position"]}',
            salary_income_commission='{$_POST["salary_income_commission"]}',
            salary_commission_stock='{$_POST["salary_commission_stock"]}',
            salary_holiday='{$_POST["salary_holiday"]}',
            salary_income_holiday='{$_POST["salary_income_holiday"]}',
            salary_income_overtime_hours='{$_POST["salary_income_overtime_hours"]}',
            salary_income_overtime='{$_POST["salary_income_overtime"]}',
            salary_income_journey='{$_POST["salary_income_journey"]}',
            salary_income_other='{$_POST["salary_income_other"]}',
            salary_income_othersum='{$_POST["salary_income_othersum"]}',
            salary_income_bonus='{$_POST["salary_income_bonus"]}',
            salary_income_bonusyear='{$_POST["salary_income_bonusyear"]}',
            salary_income_total='{$_POST["salary_income_total"]}',
            salary_expense_late='{$_POST["salary_expense_late"]}',
            salary_expense_before='{$_POST["salary_expense_before"]}',
            salary_expense_accident='{$_POST["salary_expense_accident"]}',
            salary_expense_leave='{$_POST["salary_expense_leave"]}',
            salary_expense_subtract='{$_POST["salary_expense_subtract"]}',
            salary_expense_bail='{$_POST["salary_expense_bail"]}',
            salary_expense_other='{$_POST["salary_expense_other"]}',
            salary_expense_total='{$_POST["salary_expense_total"]}',
            salary_income_sum='{$_POST["salary_income_sum"]}',
            salary_expense_insurance='{$_POST["salary_expense_insurance"]}',
            salary_expense_tax='{$_POST["salary_expense_tax"]}',
            salary_income_net='{$_POST["salary_income_net"]}',
            salary_account_id='{$_POST["salary_account_id"]}'
            WHERE salary_id='{$_POST["hidden_salary_id"]}' AND file_id='{$_POST["hidden_file_id"]}'
        ";

    $query_update_salary = mysqli_query($conn, $sql_update_salary) or die("Sql error : " . mysqli_error($conn));
    if ($query_update_salary) {
        ...
        if ($query_update_salary_detail) {
            ?>
            <script>
                alert("แก้ไขข้อมูลไฟล์เงินเดือน เรียบร้อยแล้ว!");
                window.location = "index.php?mod=fn/form_view_salary&id=<?=$_POST["hidden_file_id"]?>";
            </script>
            <?php
            exit();
        }
