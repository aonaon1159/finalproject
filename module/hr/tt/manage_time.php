            ...
            <div class="panel panel-default">
                ...
                <div class="ibox-tools">
                    ...
                    <div class="col-sm-3" style="padding:10px 15px 5px 0; text-align:right;">
                        <button type="button" class="btn btn-primary btn-sm" onclick="add_time();">
                            <i class="fa fa-sm fa-folder-open"></i> | เพิ่มข้อมูลเวลาทำงาน
                        </button>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                while ($assoc_company = mysqli_fetch_assoc($query_select_company)) {
                                                    echo $company = ($assoc_company["company_id"] == $file_assoc["scanfile_company"]) ? $assoc_company["company_name"] : "";
                                                }
                                                ?>
                                            </td>
                                            ...
                                            <td style="text-align:center;">
                                                <a href="index.php?mod=fn/form_view_time&id=<?= $file_assoc["scanfile_id"] ?>"
                                                   class="btn btn-xs btn-info"><span
                                                            class="fa fa-file-o"> | ข้อมูล</span></a>
