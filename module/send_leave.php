        ...
        <div class="col-sm-12" style="padding:0 25px 0 30px;">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-calendar"></i> ส่งใบลาหยุด (<?=$person_prename." ".$person_firstname_thai." ".$person_lastname_thai?>)
                </div>

                <div class="panel-body">
                    <form class="form-horizontal" method="post" action="index.php?mod=hr/sm_insert_request_leave" style="margin-top:15px;">
                        <div class="row">
                            <div class="col-sm-12">
