      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="container">
            <?php
            $sql_select_person = "
            SELECT * FROM hr_person WHERE person_id='{$_SESSION["uID"]}'";
                ...
                <div class="form-group col-sm-6">
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <?php 
                      $select_salary = mysqli_query($conn, "SELECT employment_money FROM hr_person_employment WHERE person_id = $person[0] ");
