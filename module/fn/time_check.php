...
$sql_select_person = "SELECT * FROM hr_person WHERE deleted = 0 AND person_id = {$_SESSION['uID']}";
$query_select_person = mysqli_query($conn,$sql_select_person);
$person = mysqli_fetch_array($query_select_person);
$sql_select_department = "SELECT * FROM hr_person_employment WHERE person_id = {$_SESSION['uID']}";
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="table-responsive">
                                ...
                                $sql_checktime = "SELECT * FROM fn_check_time 
                                                    WHERE person_id = {$_SESSION['uID']} AND month = $month AND year = $year  ORDER BY `fn_check_time`.`time_datetime` ASC ";
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_amount_check = "SELECT * FROM fn_check_time 
                                                    WHERE person_id = {$_SESSION['uID']} AND month = $month AND year = $year";
                                            ...
                                            $sql_amount_discount = "SELECT * FROM fn_check_time 
                                                    WHERE person_id = {$_SESSION['uID']} AND time_discount = 1 AND month = $month AND year = $year";
                                            ...
                                            $sql_amount_nodiscount = "SELECT * FROM fn_check_time 
                                                    WHERE person_id = {$_SESSION['uID']} AND time_discount = 0 AND month = $month AND year = $year";
